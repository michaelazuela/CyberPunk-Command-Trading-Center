...
assert.match(source, /ShowReactionGrade = true/);
...
assert.match(source, /finalBossZones/);
assert.match(source, /tradeBoxes/);
assert.match(source, /reactionZones/);
assert.match(source, /ZoneArrayName/);
assert.match(source, /ReactionGrade/);
