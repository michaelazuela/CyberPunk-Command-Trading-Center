...
import {
  buildUnifiedPositiveHeldLocalPreviewTurtleSoupReplayPackageReport,
...
const rows = [
  row('2026-06-17-morning-TurtleSoup-LONG-a', 'winner', 'Conditional', false, 100),
  row('2026-06-18-lunch-TurtleSoup-LONG-a', 'winner', 'Conditional', false, 80),
  row('2026-06-19-morning-TurtleSoup-LONG-a', 'loss', 'Blocked', true, -60),
  row('2026-06-20-lunch-TurtleSoup-LONG-a', 'loss', 'Blocked', true, -50),
  row('2026-06-21-morning-TurtleSoup-LONG-a', 'unresolved', 'Conditional', true, 0),
...
assert.equal(report.reportType, 'unified_positive_held_local_preview_turtlesoup_replay_package');
...
assert.equal(report.summary.turtleSoupRows, 5);
...
assert.match(report.markdown, /TurtleSoup Replay Package/);

const missing = buildUnifiedPositiveHeldLocalPreviewTurtleSoupReplayPackageReport({
  reportDir: 'diagnostic-reports',
...
console.log('unified positive held-local TurtleSoup replay package verified.');
