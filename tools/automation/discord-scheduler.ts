...
function formatMorningSetupWatchlist(context: Partial<ChartContext> | null): string {
  ...
  return [
    ...
    '🛡️ Gate: 5M entry, structure stop, clean 1.5R path; 2.0R is T2/extension management.',
    '',
...
function formatWeeklyApprovedModels(context: Partial<ChartContext> | null): string {
  ...
  return [
    ...
    '✅ Required: stop-run -> reclaim -> displacement -> structure shift -> imbalance pullback -> 5M entry/structure stop -> clean 1.5R path.',
    `🎯 Upside draw: ${buySide}.`,
    '',
