  ...
  rows: [
    {
      ...
      competingRows: 2,
      competingSetupTypes: ['SweepMssFvgRetrace', 'HtfDisplacementMssContinuation'],
      competingLosses: 0,
      competingWinners: 2,
      bestCompetingTicketId: 'best-sweep',
      bestCompetingSetupType: 'SweepMssFvgRetrace',
...
const samebarReport = {
  ...
  timeBuckets: [],
  rows: [
    samebarRow({ ticketId: 'selected-openingdrive', proofTime: '2026-07-17T10:40:00', setupType: 'OpeningDriveFvgContinuation', oneMesPl: 42.5, riskPoints: 4.25 }),
    samebarRow({ ticketId: 'best-sweep', proofTime: '2026-07-17T10:40:00', setupType: 'SweepMssFvgRetrace', oneMesPl: 212.5, riskPoints: 8 }),
    samebarRow({ ticketId: 'htf-support', proofTime: '2026-07-17T10:40:00', setupType: 'HtfDisplacementMssContinuation', oneMesPl: 210, riskPoints: 8 }),
    samebarRow({ ticketId: 'opposite-side', proofTime: '2026-07-17T10:40:00', setupType: 'TurtleSoup', direction: 'SHORT', oneMesPl: 50 }),
  ],
  blockers: [],
  recommendations: [],
  markdown: '',
