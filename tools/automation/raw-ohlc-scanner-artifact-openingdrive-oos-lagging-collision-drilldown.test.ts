  ...
  rows: [
    {
      ...
      competingRows: 2,
      competingSetupTypes: ['SweepMssFvgRetrace', 'IntradayMssMicroContinuation'],
      competingLosses: 0,
      competingWinners: 2,
...
const samebarReport = {
  ...
  rows: [
    ...
    samebarRow({ ticketId: 'htf-support', proofTime: '2026-07-17T10:40:00', setupType: 'IntradayMssMicroContinuation', oneMesPl: 210, riskPoints: 8 }),
    samebarRow({ ticketId: 'opposite-side', proofTime: '2026-07-17T10:40:00', setupType: 'raidReclaim', direction: 'SHORT', oneMesPl: 50 }),
  ],
  blockers: [],
  recommendations: [],
  markdown: '',
