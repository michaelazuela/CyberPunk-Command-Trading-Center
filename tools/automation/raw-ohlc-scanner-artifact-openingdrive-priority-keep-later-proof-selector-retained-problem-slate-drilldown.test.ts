...
const filterSimulation: BuildArgs['filterSimulation'] = {
  status: 'pass',
  filteredSlateRows: [
    { slateId: '2026-07-01|morning|NoInstalledSetup|LONG', filterDecision: 'retained', filterReason: 'passes', adverseR: 0 },
    { slateId: '2026-07-02|morning|NoInstalledSetup|LONG', filterDecision: 'retained', filterReason: 'passes', adverseR: 2.2 },
    { slateId: '2026-07-03|morning|NoInstalledSetup|LONG', filterDecision: 'excluded_high_adverse_stopped', filterReason: 'adverseR=4', adverseR: 4 },
  ],
};
