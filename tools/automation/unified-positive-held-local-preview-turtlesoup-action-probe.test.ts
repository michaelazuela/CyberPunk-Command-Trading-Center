...
import {
  buildUnifiedPositiveHeldLocalPreviewTurtleSoupActionProbeReport,
...
assert.equal(report.reportType, 'unified_positive_held_local_preview_turtlesoup_action_probe');
...
assert.match(report.markdown, /TurtleSoup Action Probe/);

const missing = buildUnifiedPositiveHeldLocalPreviewTurtleSoupActionProbeReport({
  reportDir: 'diagnostic-reports',
...
console.log('unified positive held-local TurtleSoup action probe verified.');
