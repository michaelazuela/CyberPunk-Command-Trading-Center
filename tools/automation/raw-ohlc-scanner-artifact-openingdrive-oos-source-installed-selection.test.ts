...
const samebar = {
  ...
  rows: [
    ...
    row({ ticketId: 'od-b', setupType: 'NoInstalledSetup', proofTime: '2026-07-17T10:05:00', oneMesPl: 120, direction: 'SHORT' }),
    row({ ticketId: 'htf-b', setupType: 'NoInstalledSetup', proofTime: '2026-07-17T10:05:00', oneMesPl: 200, direction: 'SHORT' }),
    row({ ticketId: 'wrong-side-ignore', setupType: 'NoInstalledSetup', proofTime: '2026-07-17T10:05:00', oneMesPl: 500, direction: 'LONG' }),
  ],
  blockers: [],
  recommendations: [],
  markdown: '',
