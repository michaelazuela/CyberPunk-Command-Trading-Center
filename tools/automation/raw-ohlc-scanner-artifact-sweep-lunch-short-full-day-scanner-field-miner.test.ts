...
import { buildRawOhlcScannerArtifactSweepLunchShortFullDayScannerFieldMinerReport } from './raw-ohlc-scanner-artifact-sweep-lunch-short-full-day-scanner-field-miner';
...
console.log('raw OHLC scanner artifact Sweep lunch SHORT full-day scanner field miner verified.');
