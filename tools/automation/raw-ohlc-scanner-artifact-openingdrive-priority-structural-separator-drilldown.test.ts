...
const samebar = {
  ...
  timeBuckets: [],
  rows: [
    samebarRow({ ticketId: 'od-loss', setupType: 'NoInstalledSetup', date: '2026-07-09', proofTime: '2026-07-09T09:20:00', oneMesPl: -25, outcomeLabel: 'stopped_before_t1', tags: ['stopped_before_t1', 'intrabar_ambiguity'] }),
    samebarRow({ ticketId: 'priority-loss', setupType: 'NoInstalledSetup', date: '2026-07-09', proofTime: '2026-07-09T09:20:00', oneMesPl: -48.75, outcomeLabel: 'stopped_before_t1' }),
    samebarRow({ ticketId: 'od-win', setupType: 'NoInstalledSetup', date: '2026-07-17', proofTime: '2026-07-17T10:45:00', oneMesPl: 25, outcomeLabel: 't1_and_t2_hit' }),
    samebarRow({ ticketId: 'priority-win', setupType: 'NoInstalledSetup', date: '2026-07-17', proofTime: '2026-07-17T10:45:00', oneMesPl: 212.5, outcomeLabel: 't1_and_t2_hit' }),
  ],
  blockers: [],
  recommendations: [],
  markdown: '',
