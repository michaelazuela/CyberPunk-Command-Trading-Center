...
- Formal ledger reason: Watchlist/advisory samples are human-reviewed but do not use approved_for_future_model_candidate_review or not_approved_for_future_model_candidate_review. They do not count toward formal model-candidate gates unless a human later applies a formal model-candidate label.

## Concepts
### Time-Window Liquidity Delivery
- Concept: time_window_liquidity_delivery
- Watchlist Samples: 2
- Labels: keep_advisory=1; new_model_candidate_review=1
...
|---|---|---|---|---|---|
| time_window_liquidity_delivery-003 | keep_advisory | unclear_insufficient_evidence | chart_withheld | MES +$40.00 gross | review_chart |
| time_window_liquidity_delivery-014 | new_model_candidate_review | partially_agrees_with_human | chart_available | MES -$20.00 gross | decide_candidate_label |
