...
assert.ok(deskPlayText.includes('4H: BULL now | BEAR below 7271.75 | proof: close+hold below | target 7428.75'));
assert.ok(deskPlayText.includes('2H: BULL now | BEAR below 7288.25 | proof: close+hold below | target 7410.00'));
assert.ok(deskPlayText.includes('1H: BULL now | BEAR below 7303.50 | proof: close+hold below | target N/A'));
assert.ok(deskPlayText.includes('15M: BULL now | BEAR below 7342.00 | proof: close+hold below | target 7410.00'));
assert.ok(deskPlayText.includes('5M: BULL now | BEAR below 7271.75 | proof: close+hold below | target 7392.50'));
...
assert.ok(deskPlayDecisionMapText.includes('4H: BEAR now | BULL above 7423.75 | proof: close+hold above | target 7460.00'));
assert.ok(deskPlayDecisionMapText.includes('15M: BEAR now | BULL above 7440.25 | proof: close+hold above | target 7318.75'));
assert.ok(deskPlayDecisionMapText.includes('5M: BULL now | BEAR below 7350.25 | proof: close+hold below | target 7318.75'));
