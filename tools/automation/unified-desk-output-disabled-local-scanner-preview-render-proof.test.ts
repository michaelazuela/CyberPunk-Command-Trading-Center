...
const row = {
  ...
  bodyLines: [
    ...
    'HtfDisplacementFvgContinuation is the selected scanner-owned lane for this window.',
  ],
...
assert.equal(report.scannerSurfaceSmokeImportPayload?.surface.rows[0].model, 'HtfDisplacementFvgContinuation');
