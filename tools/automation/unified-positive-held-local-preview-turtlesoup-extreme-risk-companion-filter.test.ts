...
import {
  buildUnifiedPositiveHeldLocalPreviewTurtleSoupExtremeRiskCompanionFilterReport,
...
const installed: UnifiedPositiveHeldLocalPreviewSweepPenaltyInstalledScoreComparisonReport = {
  ...
  rows: [
    {
      ticketId: '2026-06-10-lunch-TurtleSoup-LONG',
...
const extreme: UnifiedPositiveHeldLocalPreviewTurtleSoupExtremeRiskRankSimulationReport = {
...
const blocked = buildUnifiedPositiveHeldLocalPreviewTurtleSoupExtremeRiskCompanionFilterReport({
  reportDir: 'reports',
...
console.log('unified positive held-local TurtleSoup extreme-risk companion filter verified.');
