...
assert.equal(deskState.primaryDeskPlay.modelRouting.bestActiveModel, SetupType.StructureShiftContinuation);
assert.equal(deskState.primaryDeskPlay.modelRouting.bestApprovedModel, SetupType.StructureShiftContinuation);
...
assert.equal(deskState.primaryDeskPlay.modelRouting.longModelFit.setupType, SetupType.StructureShiftContinuation);
assert.equal(deskState.primaryDeskPlay.modelRouting.shortModelFit.status, 'not_aligned');
assert.equal(deskState.primaryDeskPlay.longBias.modelFit.setupType, SetupType.StructureShiftContinuation);
...
assert.equal(deskState.primaryDeskPlay.longBias.executableConsideration.selectedRegisteredModel, SetupType.StructureShiftContinuation);
...
assert.equal(deskState.primaryDeskPlay.modelRouting.approvalBoundary.changesCanExecute, false);
assert.equal(deskState.primaryDeskPlay.modelRouting.approvalBoundary.changesTradeApprovals, false);
assert.equal(deskState.primaryDeskPlay.modelRouting.approvalBoundary.changesEntryStopTargets, false);
assert.equal(deskState.primaryDeskPlay.modelRouting.approvalBoundary.createsNewModel, false);
