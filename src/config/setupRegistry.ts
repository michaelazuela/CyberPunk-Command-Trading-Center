...
export const SETUP_REGISTRY: SetupRegistryEntry[] = [
  ...
  },
  {
    ...
    role: 'primary_model',
    parentModelFamily: 'FVG_TRADING_SYSTEM_V1',
    label: 'FVG Strength Continuation',
    aliases: [
      'FVG Strength Continuation',
      'No-Sweep FVG Continuation',
      'First FVG Defense',
      'Final Boss Zone Defense',
      'Shallow FVG Hold Continuation',
    ],
    priority: 98,
    allowedSessions: ALL_RESEARCH_SESSIONS,
    detectionKeywords: [
    ...
    requiredEvidence: [
      'Trend-side 15M FVG context is active from structured OHLC.',
      'Price pulls back into the first valid same-direction FVG or the Final Boss Zone.',
      'A sweep is not required.',
      'Completed 5M candle defends, holds, or reclaims from the FVG area.',
      'Stop is tied to the next valid 5M protected structure.',
      'T1/T2 are computed from actual entry-to-stop risk.',
      'Forward target room and no-chase conditions remain required.',
      'This route is decision-support only and never sets canExecute true.',
    ],
    defaultRequiredTrigger:
      'Completed 5M defense/hold from a trend-side FVG area. Boundary break is not required.',
    defaultNextAction:
      'Track the first trend-side FVG and Final Boss Zone; publish the review plan when a completed 5M candle defends the active FVG with protected 5M structure and target room.',
  },
  {
    ...
    aliases: [
      ...
      '15M FVG Defended Zone Continuation',
      '15M FVG Hold Reject Continuation',
    ],
    priority: 95,
    allowedSessions: ALL_RESEARCH_SESSIONS,
    detectionKeywords: [
      'defended battle zone continuation',
      'prior 15m battle zone defense',
      '15m fvg defended zone',
      '15m fvg hold reject',
      'battle zone defended',
    ],
    possibleKeywords: [
      'prior 15m fvg',
      '5m defense of battle zone',
      '5m hold of battle zone',
      '5m reclaim of battle zone',
      '5m rejection from battle zone',
    ],
    requiredEvidence: [
      'A prior 15M/HTF FVG battle zone is present from structured OHLC.',
      'Completed 5M candle touches, holds, reclaims from, or rejects from the battle-zone area.',
      'The battle zone is defended; a boundary break is not required.',
    ...
    defaultRequiredTrigger:
      'Completed 5M defense of a prior 15M FVG battle zone, with protected 5M stop and app-owned targets. Boundary break is not required.',
    defaultNextAction:
