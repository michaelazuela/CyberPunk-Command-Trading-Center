...
export const SETUP_REGISTRY: SetupRegistryEntry[] = [
  ...
  },
  {
    ...
    requiredEvidence: [
      ...
      'Completed 5M FVG retest/rejection or completed close-through beyond the HTF line in the sand',
    ...
    defaultRequiredTrigger: 'Human-review only: aligned completed 15M and 5M MSS, then a completed 5M FVG retest/rejection or close-through beyond the named HTF line in the sand.',
    defaultNextAction: 'No chase. Produce a micro-continuation plan for human review only after the completed 5M retest/rejection or close-through confirms; canExecute remains false.',
  },
  {
