...
const maintenanceWindow = resolveScannerWindow(new Date('2026-05-19T17:30:00-04:00'));
...
const sundayBeforeReopenWindow = resolveScannerWindow(new Date('2026-06-14T17:59:00-04:00'));
...
assert.equal(morningWindow.label, CONTINUOUS_REVIEW_MONITOR_LABEL);
...
assert.equal(noonLunchPmWindow.label, CONTINUOUS_REVIEW_MONITOR_LABEL);
...
assert.equal(maintenanceWindow.session, 'outside');
assert.equal(maintenanceWindow.label, 'Market Closed - CME Maintenance');
assert.equal(maintenanceWindow.allowsTradePlan, false);
assert.equal(maintenanceWindow.allowsDiscordAlert, false);
assert.equal(maintenanceWindow.nextWindowLabel, CONTINUOUS_REVIEW_MONITOR_LABEL);
assert.equal(beforeEveningWindow.session, 'premarket');
assert.equal(beforeEveningWindow.label, CONTINUOUS_REVIEW_MONITOR_LABEL);
assert.equal(beforeEveningWindow.nextWindowLabel, null);
...
assert.equal(eveningWindow.label, CONTINUOUS_REVIEW_MONITOR_LABEL);
...
assert.equal(sundayBeforeReopenWindow.session, 'outside');
assert.equal(sundayBeforeReopenWindow.nextWindowLabel, CONTINUOUS_REVIEW_MONITOR_LABEL);
assert.equal(sundayBeforeEveningWindow.session, 'premarket');
assert.equal(sundayBeforeEveningWindow.nextWindowLabel, null);
