...
assert.equal(report.primaryModelCount, 0);
...
assert.match(report.notes.join(' '), /Blank-slate mode is active/);

console.log('scannerModelE2EHealth blank-slate contract verified');
