...
function aug25MesMorningFvgFailureShortContext(): ChartContext {
  const candles: NonNullable<ChartContext['candles']> = [
    ...
    direction: (close as number) > (open as number) ? 'bullish' : (close as number) < (open as number) ? 'bearish' : 'doji',
  ...
  return {
    ...
    reclaimEvents: [],
    failedBreakEvents: [],
    displacementCandles: factSet('5m', 'execution').displacementCandles,
    setupReadyFacts: {
      pullbackIntoFvg: true,
      fvgReclaimed: false,
      breakOfStructure: true,
      sweepThenReclaim: false,
      notes: ['2026-08-25 opening FVG failure short fixture.'],
    },
    multiTimeframeContext: {
      source: 'ninjatrader_bridge',
      authority: 'ohlc_facts_only',
    ...
    timeframeMssEvidence: timeframeMssEvidenceLayer('bearish', {
      '5M': {
        evidenceTimestamp: '2026-08-25T09:50:00-04:00',
        barTimestampMode: 'open',
        structureBreak: {
          type: 'mss',
          brokenLevel: 7694.75,
          brokenSwingTimestamp: '2026-08-25T09:30:00-04:00',
          priorStructureDirection: 'bullish',
          closeThroughPoints: 1.5,
          wickOnlyBreak: false,
        },
      },
      '15M': {
        evidenceTimestamp: '2026-08-25T09:45:00-04:00',
        barTimestampMode: 'open',
      },
    }),
    ...
    targetObjectives: [{
      label: 'Morning sell-side liquidity',
      price: 7688,
      direction: 'SHORT',
      source: 'app',
      type: 'liquidity_pool',
      confidence: 'High',
      score: 85,
      reason: 'Real 5M/session sell-side liquidity below the failed FVG trigger.',
    }],
    structuralLevels: [{
      label: 'Morning sell-side liquidity',
      price: 7688,
    ...
    marketContext: 'MES 2026-08-25 morning: 15M bearish FVG failed, 5M retested and accepted lower.',
  };
}
