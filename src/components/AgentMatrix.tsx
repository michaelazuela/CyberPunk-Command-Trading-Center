  ...
  const getRandomMessage = (step: number) => {
    const messages = [
      ...
      [
        ...
        "Verifying structure stop and actual risk...",
  ...
  return (
    <div className="flex flex-col h-full bg-black border border-[var(--b1)] rounded-lg overflow-hidden font-mono shadow-2xl">
      ...
      <div className="flex-1 flex flex-col min-h-0">
        {/* Live Stats Rail (Cosmetic) */}
        <div className="grid grid-cols-3 border-b border-[var(--b1)] divide-x divide-stone-800" title="Simulated aesthetic telemetry">
        ...
        {/* Bottom Status Bar */}
        <div className="px-4 py-2 bg-stone-900 border-t border-[var(--b1)] flex justify-between items-center" title="Simulated Matrix Interface">
          <div className="flex items-center gap-2">
            <Database className="w-3 h-3 text-stone-500" />
            <span className="text-[10px] text-stone-500 uppercase">SYS ALLOCATED</span>
          </div>
          <div className="flex items-center gap-2">
