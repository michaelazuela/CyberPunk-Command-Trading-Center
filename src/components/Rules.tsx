...
const SYSTEM_RULES: Setup[] = [
  {
    ...
    shortExplanation: 'Used when the 9:30 impulse is extended. Instead of chasing, we wait for a deeper value-area retest and a clean structure-based trigger.',
    conditions: ['Extended opening impulse', 'Clear impulse leg established', 'A structure stop and acceptable actual risk can be defined'],
  ...
  },
  {
    ...
    shortExplanation: 'Triggered at the 9:30-9:35 range extremes when confirmation allows a structure stop with acceptable actual risk.',
