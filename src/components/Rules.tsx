...
const SYSTEM_RULES: Setup[] = [
  {
    ...
    shortExplanation: 'Used when the stop distance to the 9:30 extreme is > 15 points. Instead of chasing, we wait for a deeper discount.',
    conditions: ['Risk to 9:30 extreme is > 15 pts', 'Clear impulse leg established'],
  ...
  },
  {
    ...
    shortExplanation: 'Triggered when risk to 9:30 extreme is > 15 pts. Wait for confirmation at the extremes.',
